...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top"><img src="img/DESAIN 2.png" alt=" "></a> </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#testimonials" class="page-scroll">Artikel</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            ...
            <p>Sablon Manual | Sablon Heat Press | Cutting Sticker <br>Kaos Polos | Jersey Bola.</p>
    ...
    <div class="row">
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          ...
          <hr>
          <p>Kami menyediakan Jasa Sablon manual yang berkualitas, menggunakan tinta plastisol dan kaos cotton combed 30s/24s dalam produksi, serta kami menyediakan sablon heat press dengan poliflex/vinil untuk pakaian jenis jersey.</p>
          <p>kami juga menjual produk berupa kaso cotton combed 30s/24s dengan kualitas terjamin serta menyediakan jasa cutting stiker untuk modifikasi motor / mobil.</p>
          <a href="#services" class="btn btn-custom btn-lg page-scroll">View All Services</a> </div>
      </div>
      <div class="col-xs-12 col-md-3">
        <div class="about-media"> <img src="img/about01.jpg" alt=" "> </div>
        <div class="about-desc">
          <h3>Kaos Berkualitas</h3>
          <p>Tersdia beragam warna dan pilihan dengan bahan berkualitas standar distro yang lembut, dingin, serta menyerap keringat.</p>
        </div>
      </div>
      <div class="col-xs-12 col-md-3">
        <div class="about-media"> <img src="img/about02.jpg" alt=" "> </div>
        <div class="about-desc">
...
<div id="services">
  <div class="container">
    <div class="col-md-10 col-md-offset-1 section-title text-center">
      <h2>Our Services</h2>
      <hr>
      <p>Kami menyediakan jasa seperti SABLON MANUAL, SABLON HEAT PRESS, CUTTING STICTKER dan juga prodi seperti KAOS POLOS, SWEATER, JERSEY dll</p>
    </div>
    <div class="row">
...
<div id="portfolio">
  <div class="container">
    <div class="section-title text-center center">
      ...
      <hr>
      <p>Kaos polos KOZE merupakan kaos polos produksi dalam negri dengan kualitas ekspore cocok digunakan sebagai kaos harian ataupun bahan kaos untuk sablon manual, heat press vinil, DTG, ataupun heat transfer.</p>
    </div>
...
<div id="footer">
  <div class="container text-center">
    <div class="col-md-8 col-md-offset-2">
      <div class="social">
        <ul>
          <li><a href="https://m.facebook.com/Partnersablon-619631078529240"><i class="fa fa-facebook"></i></a></li>
      ...
      <p>&copy; 2019 Partner Sablon. Designed by Syahroni.ST</p>
    </div>
  </div>
</div>
